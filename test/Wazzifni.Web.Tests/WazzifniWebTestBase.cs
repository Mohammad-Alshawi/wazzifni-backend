...
{
    public abstract class WazzifniWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WazzifniWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WazzifniWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WazzifniDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WazzifniDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WazzifniDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WazzifniDbContext, Task<T>> func)
        {
            T result;
